...
<head>
    ...
    <title>Dashboard Pasien - Sistem Klinik</title>
...
<body>
    <nav class="navbar navbar-dark bg-primary mb-4">
        <div class="container">
            ...
            <div class="d-flex text-white align-items-center">
                ...
                <a href="index.php?action=reservations" class="btn btn-sm btn-info me-2">Riwayat Reservasi</a>
    ...
    <div class="container mt-4">
        <h4 class="mb-3">Jadwal Praktik Dokter</h4>
            ...
            <table class="table table-striped bg-white rounded shadow-sm">
                ...
                <tbody>
                    <?php if (empty($doctors)): ?>
                        <tr><td colspan="12" class="text-center">Belum ada dokter yang tersedia.</td></tr>
                    <?php else: ?>
                        <?php foreach ($doctors as $doc): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <?php if ($isAvailable): ?>
                                        <a href="index.php?action=book&id=<?php echo $doc['id']; ?>" class="btn btn-sm btn-success">Booking</a>
                                    <?php else: ?>
